...
import com.geeks.myapplication.databinding.ItemCakesBinding
...
class CakesAdapter(val cakesList: ArrayList<Cakes>, val listener: (position: Int) -> Unit) :
    ...
    inner class CakesViewHolder(val binding: ItemCakesBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CakesViewHolder {
        val binding = CakesViewHolder(
            ItemCakesBinding.inflate(
